...
local function SetBorder(self, width, r, g, b, a)
  Library.LibExtendedWidgets.SetBorder(self.scroller, width, r, g, b, a)
end
...
function Library.LibExtendedWidgets.TextArea(name, parent)
  ...
  Library.LibExtendedWidgets.EventProxy(widget, {"TextAreaChange","TextAreaSelect"})
