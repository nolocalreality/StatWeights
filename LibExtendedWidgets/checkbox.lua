...
local function SetText(self, text, html)
  assert(type(text) == "string", "param 1 must be a string!")
  if html then    
    self.label:SetText(text, true)
  else
...
function Library.LibExtendedWidgets.Checkbox(name, parent)
  ...
  Library.LibExtendedWidgets.EventProxy(widget, {"CheckboxChange", "MouseIn", "MouseOut", "MouseMove"})
