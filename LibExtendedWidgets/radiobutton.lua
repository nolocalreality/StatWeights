...
local function SetSelected(self, selected, silent)
  ...
  self.check:SetTexture("LibExtendedWidgets", GetTexture(self.check.checked, self.enabled))
...
function Library.LibExtendedWidgets.RadioButton(name, parent)
  ...
  widget.check:SetTexture("LibExtendedWidgets", GetTexture(false, true))
  ...
  Library.LibExtendedWidgets.EventProxy(widget, {"RadioButtonSelect", "MouseIn", "MouseOut", "MouseMove"})
