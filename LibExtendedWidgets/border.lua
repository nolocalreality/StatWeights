...
function Library.LibExtendedWidgets.SetBorder(...)
  if type(select(1, ...)) == "string" then
    ...
    if border == nil or border.type ~= borderType then
      ...
      border = Library.LibExtendedWidgets.CreateBorder(...)
  ...
  elseif type(select(1, ...)) == "table" then
    ...
    if border == nil or border.type ~= "plain" then
      ...
      border = Library.LibExtendedWidgets.CreateBorder("plain", frame, width, r, g, b, a)
      border:SetVisibleBorders(borders)
    else
      border:SetWidth(width)
      border:SetColors(borders, r, g, b, a)
...
function class:CreateFrames_rounded()
  ...
  self.top:SetTexture("LibExtendedWidgets", "textures/rounded_top.png")
  self.bottom:SetTexture("LibExtendedWidgets", "textures/rounded_bottom.png")
  self.left:SetTexture("LibExtendedWidgets", "textures/rounded_left.png")
  self.right:SetTexture("LibExtendedWidgets", "textures/rounded_right.png")
  self.topleft:SetTexture("LibExtendedWidgets", "textures/rounded_topleft.png")
  self.topright:SetTexture("LibExtendedWidgets", "textures/rounded_topright.png")
  self.bottomleft:SetTexture("LibExtendedWidgets", "textures/rounded_bottomleft.png")
  self.bottomright:SetTexture("LibExtendedWidgets", "textures/rounded_bottomright.png")
...
function class:CreateFrames_tooltip()
  ...
  self.top:SetTexture("LibExtendedWidgets", "textures/tooltip_top.png")
  self.bottom:SetTexture("LibExtendedWidgets", "textures/tooltip_bottom.png")
  self.left:SetTexture("LibExtendedWidgets", "textures/tooltip_left.png")
  self.right:SetTexture("LibExtendedWidgets", "textures/tooltip_right.png")
  self.topleft:SetTexture("LibExtendedWidgets", "textures/tooltip_topleft.png")
  self.topright:SetTexture("LibExtendedWidgets", "textures/tooltip_topright.png")
  self.bottomleft:SetTexture("LibExtendedWidgets", "textures/tooltip_bottomleft.png")
  self.bottomright:SetTexture("LibExtendedWidgets", "textures/tooltip_bottomright.png")
...
function Library.LibExtendedWidgets.CreateBorder(borderType, frame, ...)
