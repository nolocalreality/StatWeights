...
local function SetBorder(self, width, r, g, b, a)
  Library.LibExtendedWidgets.SetBorder(self.current, width, r, g, b, a)
  Library.LibExtendedWidgets.SetBorder(self.dropdown, width, r, g, b, a)
end
...
local function SetItems(self, items, values)
  assert(type(items) == "table", "param 1 must be a table! Type is ".. type(items))
...
function Library.LibExtendedWidgets.Select(name, parent)
  ...
  widget.button:SetTexture("LibExtendedWidgets", BUTTON_NORMAL)
  ...
  widget.button.Event.MouseIn = function(self) self:SetTexture("LibExtendedWidgets", BUTTON_HIGHLIGHT) end
  widget.button.Event.MouseOut = function(self) self:SetTexture("LibExtendedWidgets", BUTTON_NORMAL) end
  widget.button.Event.LeftDown = function(self) self:SetTexture("LibExtendedWidgets", BUTTON_CLICKED) end
  widget.button.Event.LeftUp = function(self) self:SetTexture("LibExtendedWidgets", BUTTON_HIGHLIGHT) end
  ...
  Library.LibExtendedWidgets.EventProxy(widget, {"ItemSelect"})

  Library.LibExtendedWidgets.SetBorder(widget.current, 1, 165/255, 162/255, 134/255, 1, "t")
  Library.LibExtendedWidgets.SetBorder(widget.current, 1, 103/255, 98/255, 88/255, 1, "lr")
  Library.LibExtendedWidgets.SetBorder(widget.current, 1, 17/255, 66/255, 55/255, 1, "b")
  Library.LibExtendedWidgets.SetBorder(widget.dropdown, 1, 165/255, 162/255, 134/255, 1, "tblr")
