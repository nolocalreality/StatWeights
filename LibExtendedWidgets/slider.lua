...
local function SetBorder(self, width, r, g, b, a)
  ...
  Library.LibExtendedWidgets.SetBorder(self.editor, width, r, g, b, a)
...
local function SetEditable(self, editable)
  ...
  if editable then
    if not self.editor then
      ...
      Library.LibExtendedWidgets.SetBorder(self.editor, 1, 0.5, 0.5, 0.5, 1)
...
function Library.LibExtendedWidgets.Slider(name, parent)
  ...
  Library.LibExtendedWidgets.SetBorder(widget.current, 1, 0.5, 0.5, 0.5, 1)
  ...
  Library.LibExtendedWidgets.EventProxy(widget, {"SliderChange","SliderGrab","SliderRelease"})
