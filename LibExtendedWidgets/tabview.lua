...
local LSW_SetBorder = Library.LibExtendedWidgets.SetBorder
...
function Library.LibExtendedWidgets.TabView(name, parent)
  ...
  Library.LibExtendedWidgets.EventProxy(widget, { "TabSelect" })
